package com.bobo.boom.componet;
...
import com.bobo.boom.BoomApp;
import com.bobo.boom.util.LogUtil;
...
public class CrashHandler implements Thread.UncaughtExceptionHandler{
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        Toast.makeText(BoomApp.getInstance(), "抱歉,程序发生异常即将退出", Toast.LENGTH_SHORT).show();
        BoomApp.getInstance().exitApp();
    }
